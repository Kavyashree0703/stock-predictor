...
page = st.sidebar.selectbox("Navigation", ["Home", "Stock Predictor"])

# --- Home Page ---
if page == "Home":
    st.title("🏠 Welcome to Stock Price Predictor Dashboard")
    st.write("""
    ...
    """)
    st.write("Use the sidebar to navigate to the **Stock Predictor** page.")
